# Grouped Research Questions — OpenFrontBench Lit Review

**Companion to:** `detailed_research_questions.md` (180 questions, numbered
`1.`–`180.`) and `../iter_1/proposal_v1.md`
**Purpose:** The same 180 questions reorganised into 10 themes for focused
per-theme briefs (`research-prompts/theme-1.md` … `theme-10.md`). Original
question numbers are preserved so the T6 batch regex keeps parsing them.

---

## Theme 1: Harness Engineering

*Sections A, K, Z — questions 1–6, 61–66, 151–156.*
...
## Theme 2: MCP Tool Surfaces

*Sections B, M, P — questions 7–12, 73–78, 91–96.*
...
## Theme 3: RTS Dynamics

*Sections C, S, T — questions 13–18, 109–114, 115–120.*
...
## Theme 4: Metrics, PMR and RAG

*Sections D, E, V — questions 19–24, 25–30, 127–132.*
...
## Theme 5: Determinism and Replay

*Sections F, AA, AB — questions 31–36, 157–162, 163–168.*
...
## Theme 6: Observation and Narration

*Sections G, X, Y — questions 37–42, 139–144, 145–150.*
...
## Theme 7: Memory and Coach

*Sections I, O, R — questions 49–54, 85–90, 103–108.*
...
## Theme 8: Baselines and Comparison

*Sections L, N, Q, U, W — questions 67–72, 79–84, 97–102, 121–126, 133–138.*
...
## Theme 9: Safety and Provenance

*Sections J, AC — questions 55–60, 169–174.*
...
## Theme 10: Scaling and Evaluation Design

*Sections H, AD — questions 43–48, 175–180.*
